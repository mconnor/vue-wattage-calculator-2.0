                  ...
                  <div>
                        ...
                        <p class="select control">
                              <select v-model.number='current_lumens'>
                                    <option v-for="option in lumen_options" :value="option.val">
                                          {{ option.val }}
                                    </option>
                              </select>
                        </p>
...
export default {
  ...
  computed: {
    ...
    inc_wattage() {
      return (this.current_lumens * this.inc_conv)
        .toFixed(2);
    },
    hal_wattage() {
      return (this.current_lumens * this.hal_conv)
        .toFixed(2);
    },
    cfl_wattage() {
      return (this.current_lumens * this.cfl_conv)
        .toFixed(2);
    },
    led_wattage() {
      return (this.current_lumens * this.led_conv)
        .toFixed(2);
    },
    ...
    inc_tcost() {
      ...
      return ((this.inc_wattage * this.total_hours * this.cost) / 1000)
        .toFixed(2);
    },
    hal_tcost() {
      // const hal_wattage = (this.current_lumens * this.hal_conv).toFixed(2);
      // console.log('hal_wattage ' +this.hal_wattage);
      return ((this.hal_wattage * this.total_hours * this.cost) / 1000)
        .toFixed(2);
    },
    cfl_tcost() {
      // const cfl_wattage = (this.current_lumens * this.cfl_conv).toFixed(2);
      return ((this.cfl_wattage * this.total_hours * this.cost) / 1000)
        .toFixed(2);
    },
    led_tcost() {
      //  const led_wattage = (this.current_lumens * this.led_conv).toFixed(2);
      return ((this.led_wattage * this.total_hours * this.cost) / 1000)
        .toFixed(2);
    },
